            ...
            {isAuthenticated && <div className='mt-10' >
                ...
                <div className='flex flex-row flex-wrap justify-around mt-10'>
                    <div className="card w-96 glass my-6 mx-4">
                        {myUser.image
                            ? <figure><img src={`http://localhost:8080/uploads/images/${myUser.image}`} alt="Maid" /></figure>
                    ...
                    <div>
                        <Form method="post" className="space-y-8" encType="multipart/form-data" onSubmit={handleUpdate}>
