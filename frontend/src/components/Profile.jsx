...
export default function Profile() {
    ...
    const handleUpdate = async (event) => {
        ...
        try {
            ...
            const response = await fetch(`https://askservice2-0.onrender.com/profile/${user._id}`, {
                method: 'POST',
    ...
    async function handleAccDelete(userId) {
        ...
        try {
            const response = await fetch(`https://askservice2-0.onrender.com/profile/${userId}`, {
                method: 'DELETE',
                headers: {
            ...
            {isAuthenticated && <div className='mt-10' >
                ...
                <div className='flex flex-row flex-wrap justify-around mt-10'>
                    <div className="card w-96 glass my-6 mx-4">
                        {myUser.image
                            ? <figure><img src={`https://askservice2-0.onrender.com/uploads/images/${myUser.image}`} alt="ProfilePic" style={{ height: 300, width: 450, }} /></figure>
