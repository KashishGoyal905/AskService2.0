...
export default function JobProfile() {
    ...
    return (
        <>
            <div className='mt-5'>
                <h1 className='text-center text-2xl lg:text-3xl my-5 uppercase lg:font-bold'>{params.jobProfile}'s</h1>
                <hr />
                <div className="flex flex-col flex-wrap space-around place-content-center hire">
                    ...
                    {jobs && jobs.length > 0 &&
                        jobs.map(job => {
                            ...
                            return (
                                <div key={job._id} className="card w-3/4 h-3/5 md:h-96 lg:card-side bg-gray-800 shadow-xl mx-5 my-8">
                                    {/* <figure className='h-full w-full lg:w-1/2'> */}
                                    <img className='h-2/5 md:h-full w-full md:w-1/2 object-cover' src={job.avatar} alt="Album" />
                                    {/* </figure> */}
                                    <div className="card-body h-3/5 md:h-full w-full md:w-1/2 p-4 md:p-8">
                                        <h1 className="text-center md:text-right text-xl md:font-bold md:text-2xl md:mt-2">{job.fullname}</h1>
                                        <h2 className="text-left md:text-xl">
            ...
            <dialog className="modal p-4" id="my_modal_1">
