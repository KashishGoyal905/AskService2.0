export default function Footer() {
    return (
        <footer className="footer footer-center p-10 bg-primary text-primary-content">
            <aside>
                <img src="https://img.icons8.com/ios-filled/100/carpenter.png" alt="Workers_Logo" style={{ height: 50, width: 50 }} />
                <p className="font-bold text-lg">
                    AskService Ltd. <br />Providing reliable Workers since 2024
                </p>
